...
class HeroAdapter(private var heroListFragment: HeroListFragment, private var heroesList: List<HeroData>?) :
    BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        if (p1 == null) {
            val inflater =
                heroListFragment.activity?.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    ...
    fun setImageView(imageView: ImageView?, curHero: HeroData?) {
        Picasso.with(heroListFragment.activity)
